   ...
   TopDownCombat playerCombat;
    ...
    public void Attack()
    {
        ...
        foreach (Collider player in hitPlayer)
        {
            ...
            playerCombat = GameObject.FindGameObjectWithTag("Player").GetComponent<TopDownCombat>();//allows this script to accsess the playerCombat script
